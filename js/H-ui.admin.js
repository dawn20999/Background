...
function getskincookie(){
	...
	if(hrefStr!=undefined){
		var hrefRes=hrefStr.substring(0,hrefStr.lastIndexOf())+v+'/skin.css';
...
$(function(){
	...
	$(".Hui-aside").on("click",".menu_dropdown li",function(){
			$(".menu_dropdown ul li").removeClass('active1');
